...
CREATE STREAM IF NOT EXISTS S_CUSTOMER_UPSERT (
...
CREATE TABLE IF NOT EXISTS T_CUSTOMER_PROFILE AS
  SELECT
    customer_id,
...
CREATE STREAM IF NOT EXISTS S_CUSTOMER_ORDER_ENRICHED WITH (
...
CREATE TABLE IF NOT EXISTS T_CUSTOMER_ORDER_SUMMARY AS
  SELECT
    customer_id,
...
CREATE STREAM IF NOT EXISTS S_SEGMENT_SOURCE WITH (
